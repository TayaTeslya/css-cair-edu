/*
Данный файл является скриптом сервера
Переменные:
    mysql - модуль для работы с базой данных
    express - фреймворк для работы с сервером
    bodyParser - библиотека для вытаскивания данных
    fileUpload - библиотека для загрузки файлов на сервер
    cors - библиотека для настройки работы с браузером
    fs - библиотека для загрузки файлов на сервер
    cryptoJS - библиотека для шифрования данных
    app - объект сервера
    connection - подключение к базе даных
*/
