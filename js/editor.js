/*
Данный файл является скриптом редактора кода на страницах создания/редактирования и прохождения уровня
Переменные:
    editor - объект редактора кода
    resultDom - объект для вывода результата пользователского кода
    defaultCode - начальный код уровней
    isValid - флаг валидности введенного кода
Функции:
    editor.on - событие изменения редактора кода; проверка валидности, отображение результата введенного кода или изменение флага валидности
*/
